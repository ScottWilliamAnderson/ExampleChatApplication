...
xdotool type --window "$(xdotool search --name 'Node: h1')" 'iperf -i 10 -t 60 -c 10.0.0.3' 
sleep 1
xdotool key --window "$(xdotool search --name 'Node: h1')" Return

sleep 65

xdotool type --window "$(xdotool search --name 'Node: h2')" 'iperf -i 10 -t 60 -c 10.0.0.3' 
sleep 1
xdotool key --window "$(xdotool search --name 'Node: h2')" Return

sleep 65

xdotool type --window "$(xdotool search --name 'Node: h3')" 'iperf -i 10 -t 60 -c 10.0.0.3' 
sleep 1
xdotool key --window "$(xdotool search --name 'Node: h3')" Return

sleep 65

xdotool type --window "$(xdotool search --name 'Node: h4')" 'iperf -i 10 -t 60 -c 10.0.0.3' 
sleep 1
xdotool key --window "$(xdotool search --name 'Node: h4')" Return

sleep 65

xdotool type --window "$(xdotool search --name 'Node: h5')" 'iperf -i 10 -t 60 -c 10.0.0.3' 
sleep 1
